...
public:
    ...
    { UNREFERENCED_PARAMETER(ssgetFlags);
      UNREFERENCED_PARAMETER(service);
      UNREFERENCED_PARAMETER(selectionSet);
      UNREFERENCED_PARAMETER(subSelectionSet);}
    ...
    { UNREFERENCED_PARAMETER(ssgetFlags);
      ...
      UNREFERENCED_PARAMETER(selectionSet);
      UNREFERENCED_PARAMETER(subSelectionSet);
      UNREFERENCED_PARAMETER(removeIndexes);
      UNREFERENCED_PARAMETER(removeSubentIndexes);}
    ...
    ssgetAddFailed(
        ...
        resbuf *rbPoints)
    { UNREFERENCED_PARAMETER(ssgetFlags);
      UNREFERENCED_PARAMETER(ssgetMode);
      UNREFERENCED_PARAMETER(service);
      UNREFERENCED_PARAMETER(selectionSet);
      UNREFERENCED_PARAMETER(rbPoints);}
    ...
    endEntsel(
        ...
        AcEdSelectionSetService& service)
    { UNREFERENCED_PARAMETER(returnStatus);
      UNREFERENCED_PARAMETER(pickedEntity);
      UNREFERENCED_PARAMETER(pickedPoint);
      UNREFERENCED_PARAMETER(service);}
};
...
public:
    ...
    { UNREFERENCED_PARAMETER(subEntityPath);
    UNREFERENCED_PARAMETER(highlightPath);}
};
...
public:
    ...
    { UNREFERENCED_PARAMETER(subEntityPath);
    UNREFERENCED_PARAMETER(highlightPaths);}
};
...
public:
   virtual void
    ...
    { UNREFERENCED_PARAMETER(returnStatus);
      UNREFERENCED_PARAMETER(pickedEntity);
      UNREFERENCED_PARAMETER(pickedPoint);
      UNREFERENCED_PARAMETER(xformres);
      UNREFERENCED_PARAMETER(refstkres);
      UNREFERENCED_PARAMETER(service);
        }
