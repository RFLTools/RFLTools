...
// instance methods
inline FILE * AcFILE::fopen(const wchar_t *pName, const wchar_t *pMode)
{
    AcFILE_Assert(this->mpFILE == NULL);
    this->mpFILE = ::_wfopen(pName, pMode);
    return this->mpFILE;
}

inline FILE * AcFILE::fsopen(const wchar_t *pName, const wchar_t *pMode, int shflag)
{
    AcFILE_Assert(this->mpFILE == NULL);
    this->mpFILE = ::_wfsopen(pName, pMode, shflag);
    return this->mpFILE;
}
...
inline int AcFILE::fprintf(const wchar_t *pFmtStr, ...)
{
    AcFILE_Assert(this->mpFILE != NULL);
    va_list va;
    va_start(va, pFmtStr);
...
inline int AcFILE::vfprintf(const wchar_t *pFmtStr, va_list va)
{
