...
public:    
    ...
    Acad::ErrorStatus findFile(AcString& fileOut,
        const ACHAR * pcFilename,
    ...
    /// <param name="">return the corresponding URL, if any</param>
    /// <returns>Return true if this is a remote file, false otherwise.</returns>
    Adesk::Boolean isRemoteFile(const ACHAR * pszLocalFile, AcString&);
