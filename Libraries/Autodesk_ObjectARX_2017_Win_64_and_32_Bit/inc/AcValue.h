...
public:
    ...
    ACDBCORE2D_PORT AcValue(Adesk::Int32 lValue);
    ACDBCORE2D_PORT AcValue(double fValue);
    ACDBCORE2D_PORT AcValue(const std::time_t& date);
    ...
    ACDBCORE2D_PORT       operator std::time_t     (void) const;
    ...
    ACDBCORE2D_PORT AcValue& operator=            (std::time_t date);
    ...
    ACDBCORE2D_PORT bool  get                     (std::time_t& date) const;
    ...
    ACDBCORE2D_PORT bool  set                     (const std::time_t& date);
