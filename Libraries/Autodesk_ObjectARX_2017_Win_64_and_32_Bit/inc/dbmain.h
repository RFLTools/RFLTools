...
// Todo: change args to const AcRxObject *
ACDBCORE2D_PORT bool          acdbIsPersistentReactor(const void *pSomething);
...
ACDBCORE2D_PORT void acdbCore2dCleanUp();
...
public:
    ...
    // Todo: Return const AcArray<AcRxObject *> *. Remove non-const override
