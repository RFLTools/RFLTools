...
class AdCharFormatter
{
  public:
    ...
    static ACPAL_PORT unsigned wcharToAnsiOrUtf8(wchar_t wch, char *pDestBuf,
    ...
    // 
    static ACPAL_PORT int isNativeToCodePage(wchar_t wch,  // Input wide char.
    ...
    // The destination buffer length is not enough.
    // 
    static ACPAL_PORT int isNativeToCodePageId(wchar_t wch,  // Input wide char.
    ...
    static ACPAL_PORT int wcharNonNativeToCIF(const wchar_t *szSrc,   // Source wide string.
