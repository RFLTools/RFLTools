...
#pragma comment (lib ,"acdb21.lib")
#pragma comment (lib ,"acge21.lib")
#pragma comment (lib ,"acISMobj21.lib")
#pragma comment (lib ,"acgiapi.lib")
#pragma comment (lib ,"axdb.lib")
#pragma comment (lib ,"ac1st21.lib") 
#ifdef _DBX_HOST_APPLICATION_
	#pragma comment (lib ,"acurlutl21.lib")
#endif // _DBX_HOST_APPLICATION_
#ifdef _BREP_SUPPORT_
	#pragma comment (lib ,"acgex21.lib")
	#pragma comment (lib ,"acbr21.lib")
#endif // _BREP_SUPPORT_
#else // AC_FULL_DEBUG
#pragma comment (lib ,"rxapi.lib")
#pragma comment (lib ,"acdb21d.lib")
#pragma comment (lib ,"acge21d.lib")
#pragma comment (lib ,"acISMobj21d.lib")
#pragma comment (lib ,"acgiapi.lib")
#pragma comment (lib ,"axdb.lib")
#pragma comment (lib ,"ac1st21d.lib") 
#ifdef _DBX_HOST_APPLICATION_
	#pragma comment (lib ,"acurlutl21d.lib")
#endif // _DBX_HOST_APPLICATION_
#ifdef _BREP_SUPPORT_
	#pragma comment (lib ,"acgex21d.lib")
	#pragma comment (lib ,"acbr21d.lib")
#endif // _BREP_SUPPORT_
#endif // AC_FULL_DEBUG

#ifdef _HLR_SUPPORT_
	#pragma comment (lib ,"AsdkHlrApi21.lib")
#endif
