...
#ifdef _AFXEXT
	#pragma comment (lib ,"acui21.lib")
	#pragma comment (lib ,"adui21.lib")
...
#pragma comment (lib ,"AcFdEval.lib")
	...
	#pragma comment (lib ,"aseapi21.lib")
	#pragma comment (lib ,"asiapi21.lib")
#else
	#pragma comment (lib ,"aseapi21d.lib")
	#pragma comment (lib ,"asiapi21d.lib")
#endif
