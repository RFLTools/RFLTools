...
MIDL_DEFINE_GUID(IID, LIBID_AXDBLib,0xAE7B2C8A,0x2E97,0x4406,0x81,0x60,0xE8,0xD3,0x2E,0xB0,0xB5,0x6D);
...
MIDL_DEFINE_GUID(IID, IID_IAxDbDocumentEvents,0xBDB1BF80,0xE5BB,0x448B,0xB8,0x35,0x54,0x89,0x63,0xAE,0xFF,0x26);


MIDL_DEFINE_GUID(IID, IID_IAxDbDocument,0xD7D299D3,0x9985,0x4C2B,0xBE,0x04,0x97,0x4E,0x82,0xF2,0x6D,0xAF);
