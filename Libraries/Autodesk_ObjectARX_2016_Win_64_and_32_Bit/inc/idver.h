...
// use dummy versions to make sure the incremental build will not break by version // update.
    ...
    #define ACADV_BLDSTREAM M   /*BuildStream*/
#else
    #include "_idver.h"
#endif
...
#define ACADV_VERNUM  _T(ID2STR(ACADV_BLDSTREAM)) _T(".") \
                      _T(ID2STR(ACADV_BLDMAJOR)) _T(".") \
                      _T(ID2STR(ACADV_BLDBRANCH)) _T(".") \
                      _T(ID2STR(ACADV_BLDMINOR))
#else // !_MSC_VER
...
#if defined(_MSC_VER) || defined(UNICODE)
// This definition is used when included by source files
#define ACADV_VERNAME _T(ID2STR(ACADV_RELMAJOR)) _T(".") \
                      _T(ID2STR(ACADV_RELMINOR))
#else // !_MSC_VER
// This definition is used when included by resource files
...
//
#define ACAD_COPYRIGHT    "Copyright 2015 Autodesk, Inc.  All rights reserved."
...
#ifdef _MSC_VER
// This definition is used when included by source files
#define ACAD_TLBVERSIONSTR      _T(ID2STR(ACAD_TLBVERSION_MAJOR)) _T(".") \
                                _T(ID2STR(ACAD_TLBVERSION_MINOR))
#else // !_MSC_VER
// This definition is used when included by resource files
...
#ifdef _MSC_VER
// This definition is used when included by source files
#define ACDB_TLBVERSIONSTR      _T(ID2STR(ACDB_TLBVERSION_MAJOR)) _T(".") \
                                _T(ID2STR(ACDB_TLBVERSION_MINOR))
#else // !_MSC_VER
// This definition is used when included by resource files
