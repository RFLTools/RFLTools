...
public: 
    ...
    { 
        UNREFERENCED_PARAMETER(hasCachedVal);
        return Acad::eNotImplemented; 
    }
    ...
    {
        UNREFERENCED_PARAMETER(isRelevChange);
        return Acad::eNotImplemented; 
    }
    ...
    { 
        UNREFERENCED_PARAMETER(pOtherDependency);
        UNREFERENCED_PARAMETER(isDependentOnSameThing);
    ...
    virtual void erasedOverride(const AcDbObject* pDbObj, Adesk::Boolean isErasing)
    {
        ...
        UNREFERENCED_PARAMETER(isErasing);
    }
