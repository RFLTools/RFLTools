...
public:
    ...
    {
        UNREFERENCED_PARAMETER(pNewObj); UNREFERENCED_PARAMETER(originalObjId);
        UNREFERENCED_PARAMETER(pObjClass); UNREFERENCED_PARAMETER(pDb);
        UNREFERENCED_PARAMETER(pAuditInfo);
        return false; 
    };
    ...
    virtual bool redirect(AcDbObjectId&  newObjId,
                          ...
                          AcDbAuditInfo* pAuditInfo)
    {
        UNREFERENCED_PARAMETER(newObjId); UNREFERENCED_PARAMETER(originalObjId);
        UNREFERENCED_PARAMETER(pObjClass); UNREFERENCED_PARAMETER(pDb);
        UNREFERENCED_PARAMETER(pAuditInfo);
        return false;
    };
