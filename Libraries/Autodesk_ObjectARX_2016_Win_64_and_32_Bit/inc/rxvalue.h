...
template<>
ACDB_PORT AcRxValue::AcRxValue(const AcGiPhotographicExposureParameters& v) throw();
#pragma endregion
...
template<>
ACDB_PORT AcRxValue::AcRxValue(const DimFillColor& dimFillColor) throw();
#pragma endregion
...
template<>
ACDB_PORT AcRxValue::AcRxValue(const AcStringArray& stringArray) throw();
#pragma endregion