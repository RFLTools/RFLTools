...
public:
    ...
    /// </summary>
    ACDB_PORT void      textDefinedSize(double &width, double &height) const;
    ...
    /// <returns> void </returns>
    /// </summary>
    ACDB_PORT void      setTextDefinedSize(double width, double height);
    ...
    /// <returns> void </returns>
    /// </summary>
    ACDB_PORT void      resetTextDefinedSize();
