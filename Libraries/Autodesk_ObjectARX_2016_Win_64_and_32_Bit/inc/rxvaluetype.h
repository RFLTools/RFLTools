...
inline void* operator new(size_t size, Storage* loc) { (size); return loc;} //Unreferenced parameter
#pragma pop_macro("new")

#pragma push_macro("delete")
#undef delete
inline void operator delete(void* p, Storage* loc) { (p); (loc); } //Unreferenced parameters
