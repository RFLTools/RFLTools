...
public:
                                                ...
                                                const AcDbAssocPersSubentId* pPerSubentId)
    {
        UNREFERENCED_PARAMETER(pEntity);
        UNREFERENCED_PARAMETER(pDatabase);
        UNREFERENCED_PARAMETER(pPerSubentId);
    ...
    {
        UNREFERENCED_PARAMETER(pToEntity);
        UNREFERENCED_PARAMETER(pToDatabase);
        UNREFERENCED_PARAMETER(pFromEntity);
        UNREFERENCED_PARAMETER(pFromDatabase);
        UNREFERENCED_PARAMETER(pPersSubentId);
        return Acad::eOk;
    }
    ...
    {
        UNREFERENCED_PARAMETER(pEntity);
        UNREFERENCED_PARAMETER(subentType);
        UNREFERENCED_PARAMETER(allSubentIds);
    ...
    {
        UNREFERENCED_PARAMETER(pEntity);
        UNREFERENCED_PARAMETER(pSubentClass);
        UNREFERENCED_PARAMETER(allSubentIds);
        return Acad::eNotImplemented;
    }
    ...
    {
        UNREFERENCED_PARAMETER(pEntity);
        UNREFERENCED_PARAMETER(edgeSubentId);
        UNREFERENCED_PARAMETER(startVertexSubentId);
        UNREFERENCED_PARAMETER(endVertexSubentId);
        UNREFERENCED_PARAMETER(otherVertexSubentIds);
        return Acad::eNotImplemented;
    }
                                                             ...
                                                             AcArray<AcDbSubentId>& fitPointSubentIds)
    {
        ...
        UNREFERENCED_PARAMETER(startVertexSubentId);
        UNREFERENCED_PARAMETER(endVertexSubentId);
        UNREFERENCED_PARAMETER(controlPointSubentIds);
        UNREFERENCED_PARAMETER(fitPointSubentIds);
    ...
    {
        UNREFERENCED_PARAMETER(pEntity);
        UNREFERENCED_PARAMETER(vertexSubentId);
        UNREFERENCED_PARAMETER(vertexPosition);
                                                       ...
                                                       AcGeCurve3d*&       pEdgeCurve)
    {
        UNREFERENCED_PARAMETER(pEntity);
        UNREFERENCED_PARAMETER(edgeSubentId);
        UNREFERENCED_PARAMETER(pEdgeCurve);
    ...
    {
        UNREFERENCED_PARAMETER(pEntity);
        UNREFERENCED_PARAMETER(faceSubentId);
        UNREFERENCED_PARAMETER(pFaceSurface);
                                                         ...
                                                         const AcGePoint3d&  newVertexPosition)
    {
        UNREFERENCED_PARAMETER(pEntity);
        UNREFERENCED_PARAMETER(vertexSubentId);
        UNREFERENCED_PARAMETER(newVertexPosition);
                                                       ...
                                                       const AcGeCurve3d*  pNewEdgeCurve)
    {
        UNREFERENCED_PARAMETER(pEntity);
        UNREFERENCED_PARAMETER(edgeSubentId);
        UNREFERENCED_PARAMETER(pNewEdgeCurve);
                                                       ...
                                                       const AcGeSurface*  pNewFaceSurface)
    {
        UNREFERENCED_PARAMETER(pEntity);
        UNREFERENCED_PARAMETER(faceSubentId);
        UNREFERENCED_PARAMETER(pNewFaceSurface);
                                                        ...
                                                        AcArray<AcGeCurve3d*>&       silhCurves)
    {
        ...
        UNREFERENCED_PARAMETER(faceSubentId);
        UNREFERENCED_PARAMETER(pEntityTransform);
        UNREFERENCED_PARAMETER(pGeometryProjector);
        UNREFERENCED_PARAMETER(transientSilhIds);
                                                                 ...
                                                                 int                          transientSilhId)
    {
        ...
        UNREFERENCED_PARAMETER(pEntityTransform);
        UNREFERENCED_PARAMETER(pGeometryProjector);
        UNREFERENCED_PARAMETER(transientSilhId);
                                                            ...
                                                            AcArray<int>&                transientSilhIds)
    {
        ...
        UNREFERENCED_PARAMETER(pEntityTransform);
        UNREFERENCED_PARAMETER(pGeometryProjector);
        UNREFERENCED_PARAMETER(pPersSilhId);
    ...
    {
        UNREFERENCED_PARAMETER(pEntity);
        UNREFERENCED_PARAMETER(fullSubentPath);
    ...
    {
        UNREFERENCED_PARAMETER(pMirroredEntity);
        UNREFERENCED_PARAMETER(pDatabase);
        UNREFERENCED_PARAMETER(pPersSubentIdToMirror);
