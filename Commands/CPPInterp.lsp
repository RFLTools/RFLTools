             ...
             (if (/= ELEV3 nil)
              (progn
               ...
               (while (/= nil P)
                ...
                (setq P2 (list (+ (nth 0 P1) (* (/ D3 D) (- (nth 0 P2) (nth 0 P1))))
                               (+ (nth 1 P1) (* (/ D3 D) (- (nth 1 P2) (nth 1 P1))))
                         )
                )
                (setq ELEV2 (+ ELEV1 (* (/ D3 D) (- ELEV2 ELEV1))))
                ...
                (setq D1 (distance P2 P))
                (setq D2 (distance P P3))
                ...
                (setq ELEV (+ ELEV (* (/ D3 D) (- ELEV3 ELEV2))))
                (setvar "OSMODE" 0)
                (setvar "ATTREQ" 0)
                (command ".INSERT"
                         BLOCKNAME
