(defun RFL:MAKEDCL (OUTFILENAME DCLNAME / DCLLIST NODE OUTFILE) 
 (cond 
  ...
  ((= (strcase DCLNAME) (strcase "BCPROF")) 
   (progn 
    (setq DCLLIST (list 
                        "BCPROF : dialog {\n" 
                        "                  label = \"RFL BC MoT Vertical Profile Creator\";\n" 
                        "                  : row {\n" 
                        "                          : column {\n" 
                        "                                     : toggle {\n" 
                        "                                                label = \"Draw Profile\";\n" 
  ...
  ((= (strcase DCLNAME) (strcase "DUALCAR")) 
   (progn 
    (setq DCLLIST (list 
                        "DUALCAR : dialog {\n" 
                        "                   label = \"RFL Dual Carriageway 3DPoly Creator\";\n" 
                        "                   : boxed_row {\n" 
