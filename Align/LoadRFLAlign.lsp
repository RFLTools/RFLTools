...
(defun C:DRAWBARRIER (/ *error* ANGBASE ANGDIRCMDECHO D DIR DOS EH ENT ENTLIST FRATE GETENDPOINT LASTPIECE N ORTHOMODE OS OS1 OS2 OSMODE P P1 P2 PLIST PREVENT REP REP2 RFL:ALIGNLIST S S1 S2 SIDE SNAPANG TMP W)
 (command "._UNDO" "M")
 (setq CMDECHO (getvar "CMDECHO"))
 (setvar "CMDECHO" 0)
 (setq ANGBASE (getvar "ANGBASE"))
