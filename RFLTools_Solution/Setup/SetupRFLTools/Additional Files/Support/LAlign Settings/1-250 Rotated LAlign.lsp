...
(setq RFL:LALIGNLIST (list (cons "LABELBLOCK" "STALBL")            ;  Station label block name
                           ...
                           (cons "LABELINC" 50.0)                 ;  Station label insertion increment
                           (cons "LABELSCALE" 0.5)                 ;  Station label insertion scale
                           (cons "LABELOFFSET" 2.0)               ;  Station label relative offset
                           (cons "LABELROTATE" 180.0)                ;  Station label relative rotation
                           ...
                           (cons "TICKINC" 10.0)                   ;  Station tick insertion increment
                           (cons "TICKSCALE" 0.5)                  ;  Station tick insertion scale
