...
Namespace RFLToolsApplication
    Public Class QuickTrain
        ...
        Public AlignList As New AlignList("RFL:AlignList")
        Public ProfList As New ProfList("RFL:PviList")
        Public SuperList As New SuperList("RFL:SuperList")
        ...
        ' )
        ')
        Public Function GetTruckPOut(ByVal Sta As Double, ByVal WB As Double, ByVal Gauge As Double, ByVal DX As Double,
        ...
        ' )
        ')
        Public Function FindFrontTruck(ByVal P As DataTypes.Point3d, ByVal WB As Double, ByVal WBT As Double,
